...
export function MarketSummaryCard({ coinsData }: MarketSummaryCardProps) {
  ...
  if (isLoading) {
    return (
      <Card className="bg-card h-auto min-h-[20dvh] xl:min-h-[25dvh] shadow-lg flex items-center justify-center">
  ...
  return (
    <Card className="bg-card h-auto min-h-[20dvh] xl:min-h-[25dvh] md:pb-0 pb-15 shadow-lg">
      <CardHeader>
