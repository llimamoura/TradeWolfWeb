...
const ResetPasswordValidationSchema = z.object({
  password: z.string()
    ...
    .regex(/[A-Z]/, { message: "Your password must contain at least one capital letter" })
    .regex(/[a-z]/, { message: "Your password must contain at least one minuscule letter" })
    .regex(/[0-9]/, { message: "Your password must contain at least one number" })
    .regex(/[!@#$%^&*()]/, { message: "Your password must contain at least one special character" }),
